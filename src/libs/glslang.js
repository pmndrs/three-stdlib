  ...
  return function (Module) {
      ...
      m = {
        ...
        '%U': function (a) {
          ...
          return 0 > h(d, a)
            ? f(
                Math.ceil(
                  (31 - d.getDate() + (T(S(a.getFullYear()) ? U : W, a.getMonth() - 1) - 31) + a.getDate()) / 7,
                ),
                2,
              )
            : 0 === h(d, b)
        ...
        '%V': function (a) {
          ...
          return 0 > h(e, b)
            ...
            : 0 >= h(d, e)
            ? '01'
            : f(Math.ceil((b.getFullYear() < a.A + 1900 ? a.G + 32 - b.getDate() : a.G + 1 - b.getDate()) / 7), 2)
        },
        '%w': function (a) {
          return a.F
        },
    ...
    var Ga = {
      ...
      Ha = (function () {
        ...
        ;(function () {
          if (A || 'function' !== typeof WebAssembly.instantiateStreaming || ta() || 'function' !== typeof fetch)
            return d(b)
