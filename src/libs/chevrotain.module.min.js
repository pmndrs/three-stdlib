  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      ;(e.END_OF_FILE = u.createTokenInstance(u.EOF, '', NaN, NaN, NaN, NaN, NaN, NaN)),
        ...
        (e.DEFAULT_RULE_CONFIG = Object.freeze({ recoveryValueFunc: function () {}, resyncEnabled: !0 })),
        (function (t) {
                ...
                if ('EXIT_NONE_TERMINAL' === T) {
                  ...
                  if (d < s - 1) {
                    ...
                    n(e[g], T.terminalType) &&
                      ((v = { idx: g, def: a.drop(f), ruleStack: E, occurrenceStack: m }), l.push(v))
                  } else {
                  ...
                  var R = a.cloneArr(m)
                  R.push(T.idx),
                    (v = { idx: d, def: T.definition.concat(i, a.drop(f)), ruleStack: _, occurrenceStack: R }),
                    l.push(v)
                  ...
                  ;(v = { idx: d, def: T.definition.concat([O], a.drop(f)), ruleStack: E, occurrenceStack: m }),
                    l.push(v)
                  ...
                  ;(N = { idx: d, def: T.definition.concat([I], a.drop(f)), ruleStack: E, occurrenceStack: m }),
                    l.push(N)
      ...
      ;(e.DEFAULT_MODE = 'defaultMode'),
        ...
        (e.analyzeTokenTypes = function (t, n) {
          ...
          return (
            ...
            { emptyGroups: g, patternIdxToConfig: _, charCodeToPatternIdxToConfig: k, hasCustom: i, canBeOptimized: A }
          )
        }),
        ...
        var e = [],
          n = u.map(t, function (n) {
            return u.reduce(
              t,
              function (t, r) {
                return n.PATTERN.source !== r.PATTERN.source || u.contains(e, r) || r.PATTERN === s.Lexer.NA
                  ? t
                  : (e.push(r), t.push(r), t)
              },
              [],
