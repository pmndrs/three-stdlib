...
!((t, e) => {
  ...
  ((t) => {
    ...
    return (
      ...
      (n.t = (t, e) => {
        ...
        if ((n.r(r), Object.defineProperty(r, 'default', { enumerable: !0, value: t }), 2 & e && 'string' != typeof t))
          for (var i in t) n.d(r, i, ((e) => t[e]).bind(null, i))
        return r
      }),
      (n.n = (t) => {
    ...
    (t, e, n) => {
      ...
      ;(e.defaultParserErrorProvider = {
        ...
        buildNoViableAltMessage: function (t) {
          ...
          var s = o.reduce(e, (t, e) => t.concat(e), []),
        ...
        (e.defaultGrammarValidatorErrorProvider = {
          ...
          buildAlternationPrefixAmbiguityError: function (t) {
            var e = o.map(t.prefixPath, (t) => r.tokenLabel(t)).join(', '),
          ...
          buildAlternationAmbiguityError: function (t) {
            var e = o.map(t.prefixPath, (t) => r.tokenLabel(t)).join(', '),
              n = 0 === t.alternation.idx ? '' : t.alternation.idx,
              i = `Ambiguous alternatives: <${t.ambiguityIndices.join(' ,')}> in <OR${n}> inside <${
                t.topLevelRule.name
              }> Rule,\n<${e}> may appears as a prefix path in all these alternatives.\n`,
          ...
          x = ((t, e) => {
            ...
            return (
              a.forEach(t, (t) => {
                ...
                t.accept(r)
                var i = a.map(r.result, (t) => t.orgProd)
          ...
          C = ((t, e) => {
            ...
            return (
              a.forEach(t, (t) => {
                var r = new l.NamedDSLMethodsCollectorVisitor('')
                t.accept(r)
                var i = a.groupBy(r.result, (t) => t.name),
                  o = a.pick(i, (t) => t.length > 1)
                a.forEach(a.values(o), (r) => {
                  var i = a.map(r, (t) => t.orgProd),
    ...
    function (t, e, n) {
      ...
      !((t) => {
        ...
        (e.buildAlternativesLookAheadFunc = (t, e, n, r) => {
          ...
          if (e)
            return function (e) {
              for (var r = a.map(e, (t) => t.GATE), o = 0; o < i; o++) {
                var s = t[o],
                  u = s.length,
                  c = r[o]
      ...
      var u = (() => {
        function t(t, e) {
          ...
          if (
            ...
            var p = i.map(this.lexerDefinitionErrors, (t) => t.message).join('-----------------------\n')
          ...
          var l = i.reduce(this.canModeBeOptimized, (t, e, n) => (!1 === e && t.push(n), t), [])
        ...
        return (
          (t.prototype.tokenize = function (t, e) {
            if ((void 0 === e && (e = this.defaultMode), !i.isEmpty(this.lexerDefinitionErrors))) {
              var n = i.map(this.lexerDefinitionErrors, (t) => t.message).join('-----------------------\n')
    ...
    (t, e, n) => {
      ...
      function u(t) {
        var e = r.map(t.definition, (t) => a(t))
    ...
    function (t, e, n) {
      ...
      ;(e.DEFAULT_MODE = 'defaultMode'),
        ...
        (e.analyzeTokenTypes = (t, n) => {
          ...
          var r = u.reject(t, (t) => t[l] === s.Lexer.NA),
            i = !1,
            o = u.map(r, (t) => {
              var e = t[l]
              if (u.isRegExp(e)) {
            ...
            d = u.map(r, (t) => t.PUSH_MODE),
            E = u.map(r, (t) => u.has(t, 'POP_MODE')),
      ...
      function g(t) {
        ...
        n = u.compact(n)
        var r = u.filter(n, (t) => t.length > 1)
        return u.map(r, (t) => {
          var e = u.map(t, (t) => a.tokenName(t))
          return {
      ...
      function R(t, e) {
        var n = u.filter(t, (t) => void 0 !== t.PUSH_MODE && !u.contains(e, t.PUSH_MODE))
        return u.map(n, (t) => ({
      ...
      ;(e.findStartOfInputAnchor = T),
        ...
        (e.performWarningRuntimeChecks = (t, e, n) => {
          var r = [],
            i = !1,
            o = u.compact(u.flatten(u.mapValues(t.modes, (t) => t))),
            a = u.reject(o, (t) => t[l] === s.Lexer.NA),
            p = P(n)
          return (
            e &&
              u.forEach(a, (t) => {
        ...
        f = (() => {
          ...
          return (
            (t.prototype.initRecognizerEngine = function (t, e) {
              ...
              var o = r.every(r.values(t), (t) => r.isEmpty(t.categoryMatches))
            ...
            (t.prototype.atLeastOneInternalLogic = function (t, e, n) {
              ...
              for (var l = this.doSingleRepetition(r); !0 === c.call(this) && !0 === l; ) l = this.doSingleRepetition(r)
